...
string replaceCode(string &original)
{
    const string toReplace[] = {"<",">","GameObject", " var ","private","public"," int ","float","Transform","Instantiate","Destroy","return","Quaternion","void","Update","Start"," OnCollisionEnter "," OnTriggerEnter "," StartCoroutine "," IEnumerator "," Vector3 "," Random "," Range "," GetComponent "," yield "," identity "," position "," transform "," if "," SerializeField "," Awake "," using "," FindObjectOfType "," GetComponentInChildren "," GetComponentsInChildren "," GetComponent "," OnCollisionStay "," OnCollisionExit "," CompareTag "," LoadSceneAsync "," SceneManager "," AsyncOperation "," progress "," get "," set "," Button "," onClick "," AddListener "," delegate "," Length "," Add "," true "," false "};
