...
class Resources
{
  ...
  public: std::string getFilePath(std::string relativePath)
  {
  ...
  public: std::string getFileContent(std::string path)
  {
  ...
  public: bool writeToFile(std::string path, std::string content)
  {
    try
    {
      std::ofstream temp;
